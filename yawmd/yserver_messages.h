...
#ifndef YAWMD_YSERVER_MESSAGES_H
#define YAWMD_YSERVER_MESSAGES_H

#include <stdint.h>
#include <unistd.h>
#include "ieee80211.h"

#define YACTION_CONTINUE 0 /* Operation successful, continue */
#define YACTION_ERROR 1 /* Error occured, disconnect client */
#define YACTION_DISCONNECTED 2 /* Client has disconnected */
#define YACTION_CLOSE 3 /* Close the server */

#define YUPDATE_SUCCESS 0 /* update of SNR successful */
#define YUPDATE_INTF_NOTFOUND 1 /* unknown interface */
#define YUPDATE_INTF_DUPLICATE 2 /* interface already exists */
#define YUPDATE_WRONG_MODE 3 /* tried to update snr in errprob mode or vice versa */

/* Socket location following FHS guidelines:
 * http://www.pathname.com/fhs/pub/fhs-2.3.html#PURPOSE46 */
#define YSERVER_SOCKET_PATH "/var/run/yawmdd.sock"

#define YSERVER_SHUTDOWN_REQUEST_TYPE 0
#define YSERVER_SNR_UPDATE_REQUEST_TYPE 1
#define YSERVER_SNR_UPDATE_RESPONSE_TYPE 2
#define YSERVER_DEL_BY_MAC_REQUEST_TYPE 3
#define YSERVER_DEL_BY_MAC_RESPONSE_TYPE 4
#define YSERVER_DEL_BY_ID_REQUEST_TYPE 5
#define YSERVER_DEL_BY_ID_RESPONSE_TYPE 6
#define YSERVER_ADD_REQUEST_TYPE 7
#define YSERVER_ADD_RESPONSE_TYPE 8
#define YSERVER_ERRPROB_UPDATE_REQUEST_TYPE 9
#define YSERVER_ERRPROB_UPDATE_RESPONSE_TYPE 10
#define YSERVER_SPECPROB_UPDATE_REQUEST_TYPE 11
#define YSERVER_SPECPROB_UPDATE_RESPONSE_TYPE 12
#define YSERVER_POSITION_UPDATE_REQUEST_TYPE 13
#define YSERVER_POSITION_UPDATE_RESPONSE_TYPE 14
#define YSERVER_TXPOWER_UPDATE_REQUEST_TYPE 15
#define YSERVER_TXPOWER_UPDATE_RESPONSE_TYPE 16
#define YSERVER_GAIN_UPDATE_REQUEST_TYPE 17
#define YSERVER_GAIN_UPDATE_RESPONSE_TYPE 18
#define YSERVER_HEIGHT_UPDATE_REQUEST_TYPE 19
#define YSERVER_HEIGHT_UPDATE_RESPONSE_TYPE 20
#define YSERVER_GAUSSIAN_RANDOM_UPDATE_REQUEST_TYPE 21
#define YSERVER_GAUSSIAN_RANDOM_UPDATE_RESPONSE_TYPE 22
...
/**
 * Receive the yserver_msg from a socket
 * @param sock_fd The socket file descriptor
 * @param base Where to store the yserver_msg
 * @param recv_type The received YSERVER_*_TYPE
...
#endif //YAWMD_YSERVER_MESSAGES_H
